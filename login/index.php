...
<!DOCTYPE html>
	...
	<div class="intro">
		...
		<p>My name is Yiyan and I will be guiding you through my experience playing Terraria, an action-adventure sandbox game developed by Re-Logic. I will be adding tips, walkthroughs and videos of my plays to show a more personal perspective on this story-based game. My Discord and Steam will be linked below :). Enjoy!</p>
		<button class="collapsible"><b><img src="/images/discord.png" style="height:120px;width:225px;"></b></button>
		<div class="content">
			<button onclick="copyEvent('copy')" class="copy"><p id="copy">yiyanhh#6373</p></button>
			<p class="copied">Click the text to copy it.</p>
		</div>

		<button class="collapsible"><img src="/images/steam-logo.png" class="steam"></button>
		<div class="content">
			&nbsp;&nbsp;
			<p class="steamuser">Steam username:</p>
			<button onclick="copyEvent('copy2')" class="copy2"><p id="copy2" class="copy">yhuan1</p></button>
			<p class="steamuser">Steam friendcode:</p>
			<button onclick="copyEvent('copy3')" class="copy2"><p id="copy3" class="copy">1109709146</p></button>
			<p class="copied">Click the text to copy it.</p>
			&nbsp;&nbsp;
			&nbsp;&nbsp;
		</div>
